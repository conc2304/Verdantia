...
Shader "City/CarLight"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_Light("Light", 2D) = "white" {}
		[ASEEnd][HDR]_EmissionColor("EmissionColor", Color) = (0.8867924,0.8866777,0.6065326,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_Light = IN.ase_texcoord7.xy * _Light_ST.xy + _Light_ST.zw;
				float4 tex2DNode3 = tex2D( _Light, uv_Light );
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( tex2DNode3.r * _NightEmission * _EmissionColor ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( tex2DNode3.r * _NightEmission * _EmissionColor.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Light = IN.ase_texcoord2.xy * _Light_ST.xy + _Light_ST.zw;
				float4 tex2DNode3 = tex2D( _Light, uv_Light );
...
/*ASEBEGIN
Version=18500
158;323;1295;696;805.2896;82.3764;1;True;False
Node;AmplifyShaderEditor.SamplerNode;3;-565,-92.5;Inherit;True;Property;_Light;Light;0;0;Create;True;0;0;False;0;False;-1;None;8c4a7fca2884fab419769ccc0355c0c1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;2;-487,139.5;Inherit;False;Global;_NightEmission;_NightEmission;1;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;5;-500,255.5;Inherit;False;Property;_EmissionColor;EmissionColor;1;1;[HDR];Create;True;0;0;False;0;False;0.8867924,0.8866777,0.6065326,0;0.5490196,2,0.2431373,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4;-198,46.5;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-191.2896,173.6236;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
WireConnection;7;6;12;0
ASEEND*/
//CHKSM=5F2D616485C6B2505C0D59D4E10599365DFED1F0